...
License  : Apache-2.0
Requires: voluptuous-serialize-license = %{version}-%{release}
...
%package license
Summary: license components for the voluptuous-serialize package.
Group: Default

%description license
license components for the voluptuous-serialize package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641420100
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/voluptuous-serialize
cp %{_builddir}/voluptuous-serialize-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/voluptuous-serialize/894a04ac1d0e0ff0bd046a3809f98ddd80459496
...
/usr/share/package-licenses/voluptuous-serialize/894a04ac1d0e0ff0bd046a3809f98ddd80459496
